...
| **Ачааны модуль** — бүртгэл, төлөв, үнэ, байршил, устгал/хүчингүй | ✅ |
...
| Файл | Хариуцах дүрэм |
|---|---|
| `pricing.js` | BR-01…BR-04 — жингийн шатлал, эзлэхүүн, override хязгаар |
| `package-state.js` | BR-07…BR-09a, BR-19 — төлөвийн шилжилт, байршил эзэмшил |
