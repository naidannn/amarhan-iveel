...
const packageSchema = new Schema(
  {
    ...
    /**
     * Харилцагч (BR-26). ЗААВАЛ БИШ — Эрээнд зөвхөн ачааны дугаараар мэдэгдэж
     * байх үед утас байхгүй байж болно, мөн ачаа хэзээ ч холбогдохгүй үлдэж ч
     * болно (BR-45). Төлбөр/хүргэлт үүсгэхэд ХАРИЛЦАГЧ заавал шаардана
     * (`payment.service.js`, `delivery.service.js`) — тэнд `null`-ийг
     * зөвшөөрөхгүй тодорхой алдаагаар барина.
     */
    customerId: {
