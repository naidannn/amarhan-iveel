...
> Замын төлөв (`in_transit`, `arrived`) байхгүй — бодит бүртгэл (жин/үнэ/байршил)
> нь ачаа Монголд ирсний дараа хийгддэг ([`business-rules.md` BR-07](business-rules.md)).
> `Эрээнд байгаа` (BR-45) үүнийг зөрчихгүй — зөвхөн дугаар+утсаар мэдэгдэж
> байгаа үеийн сонголт, "Ирц бүртгэх"-ээр `Бүртгэгдсэн` рүү шилждэг.

| Монгол (UI) | Код |
|---|---|
| Эрээнд байгаа | `in_erlian` |
| Улаанбаатарт ирсэн *(код: `registered`, өмнө нь "Бүртгэгдсэн")* | `registered` |
