...
> бүртгэдэггүй. **Бодит** бүртгэл (жин, эзлэхүүн, үнэ, байршил тодорхойлогдох
> мөч) ачаа **Монголд ирсний ДАРАА** хийгдэнэ. Үүнээс: хуучин гурван шатны
...
> УРЬДЧИЛСАН тэмдэглэл нэмэгдсэн — `in_erlian` төлөв: зөвхөн дугаар+утсаар
