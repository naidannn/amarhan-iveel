...
| `delivery-state.js` | BR-20…BR-21c — хүргэлтийн шилжилт, **§5.2 төлбөрийн хаалт** (override БАЙХГҮЙ), ачааны төлөв чирэх, харилцагчийн хүргэлтийн хураамжийн хаалт (`unpaidFee`, зөвхөн `createdBy: null`) |
...
| `services/delivery.service.js` | BR-21c (roadmap 5.8) — `selfCreate`/`deliverableForCustomer` (харилцагч өөрөө хүргэлт захиалах, эзэмшил шалгах) |
