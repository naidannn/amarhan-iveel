...
**Phase 0, 1, 2, 3, 4 дууссан — MVP бэлэн** (ачаа бүртгэх → төлбөр авах → хүргэх
өдөр тутмын урсгал бүрэн ажиллана). Бэлэн байгаа зүйл:
...
| Хэрэглэгчийн вэб (§3), Урамшуулал (§4), Тайлан (§6), Notification (§7) | ⛔ Phase 5+ |
