...
### 4.3 Audit log — service давхаргаас, өөрчлөлтийн дараа шууд
...
> **2026-07-31 шинэчлэл:** систем MongoDB-г **standalone** горимд ажиллуулдаг тул
> `withTransaction()` жинхэнэ Mongo session/rollback ХИЙХГҮЙ — callback дотор
> дараалан бичдэг (`src/utils/transaction.js`). Дээрх жишээнд `finalPrice`
> шинэчлэгдээд, дараа нь `auditService.record()` унавал **эхний бичлэг буцаагдахгүй**
> үлдэнэ. Энэ бол мэдэгдэж буй trade-off (§9 шийдвэр #2) — replica set/Docker-ийг
...
> **AWS S3 (2026-07-31: устсан).** Ачааны зураг/экспорт файл хадгалах зориулалттай
> `s3-upload.js` бэлэн байсан ч ямар ч route/controller үүнийг дуудаж байгаагүй
> (хэрэглэгддэггүй код). Эзэмшигчийн шийдвэрээр `aws-sdk`, `multer-s3`, `s3-zip`
> хамт устгасан. Файл хадгалалт хэрэгтэй болвол шинээр (локал disk эсвэл өөр
> үйлчилгээ үзүүлэгчээр) `src/integrations/` дор дахин нэмнэ.
...
| 2 | ~~Replica set (ганц node ч гэсэн)~~ → **Standalone** *(2026-07-31: буцаагдсан)* | Анх: транзакц ашиглах цорын ганц зам. Буцаасан шалтгаан: Docker/replica set-гүйгээр локал dev хялбар ажиллуулах эзэмшигчийн шийдвэр | Анхны хувилбар: Standalone — татгалзсан байсан (санхүүгийн эрсдэлтэй гэж үзсэн); 2026-07-31-нд эсрэгээрээ сонгогдсон |
| 2a | Атомик rollback-гүйгээр амьдрах | §2-ын үр дагавар: `withTransaction()` дараалсан бичилт болсон тул audit/мөнгийн бичилт хэсэгчлэн амжилттай явж болно | Application-level compensating logic — Payment илүү төлөлтийн зэрэглэлийн хамгаалалтад (BR-15) хэрэгжсэн: MongoDB нэг баримтын атомик `findOneAndUpdate`-ээр `reserveAllocations` (`payment.service.js`); бусад олон-баримтын урсгалд (audit, байршил) хараахан хэрэгжээгүй |
...
| 8 | AWS S3-г репогоос хасах *(2026-07-31)* | `s3-upload.js` хэрэглэгддэггүй байсан (route холбогдоогүй); Docker-той хамт дэд бүтцийг хялбарчлах | Хэрэглэгдэхгүй байгаа ч үлдээх — код цэвэрлэгээний зарчимтай зөрчилдөнө |
