...
useHead({
  title: 'Ивээл Карго — Хятадаас Монгол руу ачаа тээвэрлэлт',
  meta: [
    {
      name: 'description',
      content:
        'Ивээл Карго — Хятадаас Монгол руу 3–5 хоногт хүргэх карго үйлчилгээ. Ачаагаа онлайнаар хянаж, төлбөрөө төлж, хүргэлт захиална.',
    },
  ],
})
</script>
